...
<head>
  ...
  <link rel="stylesheet" href="./adicionar_produto.php">
  <link rel="stylesheet" href="../usuario/index.php">
...
<body>
  ...
  <div class="container">
    ...
    <?php if (isset($msg)): ?>
      <p style="color: green; margin-bottom:50px;"><?= $msg; ?></p>
    ...
    <form action="editar_produto.php?id=<?= $produto['id']; ?>" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group form-image">
        ...
        <div class="img-atual">
        <p>Imagem atual:</p>
        <img src="../imgs/produtos/<?= $produto['imagem']; ?>" alt="<?= $produto['nome']; ?>" style="width: 300px; border-radius:8px">
        </div>
      </div>
